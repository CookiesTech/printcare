...
crosscount=document.getElementById&&!document.all?document.getElementById("timer") : countupie
countup()
}

//~ if (document.all||document.getElementById)
//~ document.write('<span id="timer" style="width:'+countupwidth+'; background-color:'+countupbgcolor+'"></span>')
