$(function() {
    ...
    var i = function() {
        var i = window.innerWidth > 0 ? window.innerWidth : this.screen.width,
            s = 70;
        3170 > i ? ($("body").addClass("mini-sidebar"), $(".navbar-brand span").hide(), $(".scroll-sidebar, .slimScrollDiv").css("overflow-x", "visible").parent().css("overflow", "visible"), $(".sidebartoggler i").addClass("ti-menu")) : ($("body").removeClass("mini-sidebar"), $(".navbar-brand span").show());
        var e = (window.innerHeight > 0 ? window.innerHeight : this.screen.height) - 1;
        e -= s, 1 > e && (e = 1), e > s && $(".page-wrapper").css("min-height", e + "px")
    };
    $(window).ready(i), $(window).on("resize", i), $(".sidebartoggler").on("click", function() {
        ...
        $("body").toggleClass("show-sidebar"), $(".nav-toggler i").toggleClass("fa fa-bars"), $(".nav-toggler i").addClass("fa fa-close")
        ...
        for (var i = window.location, s = $("ul#sidebarnav a").filter(function() {
                return this.href == i
            }).addClass("active").parent().addClass("active");;) {
            if (!s.is("li")) break;
            s = s.parent().addClass("in").parent().addClass("active")
        }
    }), $(function() {
