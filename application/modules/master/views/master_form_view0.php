<div class="container-fluid">
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="card card-outline-info">
				...
				<div class="card-body">
	    <form id="masters" action="<?php echo site_url('master/add/'.$page_data); ?>" method="post">
    <input type="hidden" name="table_name" value="<?php echo $table_name; ?>">
               ...
               <div class=" col-md-4">
                  <input type="text" class="form-control" name="<?php echo $table; ?>_name" value="" placeholder="<?php echo $page_data ?>_name" required>
               </div>
	      ...
	      <!-- <div class="col-md-3" >
                  <div class="form-group">
                     <div class="form-line">
                        ...
                        <?php echo $this->Common_model->getOptionList('product_quality',''); ?>
                        </select>
                     </div>
                  </div>
               </div>
	       ...
	       <div class="col-md-3" >
               ...
               <div class="col-md-3">
                  <div class="form-group">
                     <div class="form-line">
                        <input id="table_name" type="text" class="form-control" name="hsn_sac"  placeholder="HSN / SAC" required>
                     </div>
                  </div>
               </div>
	        <div class="col-md-3">
                  <div class="form-group">
                     <div class="form-line">
                        <input id="table_name" type="text" class="form-control" name="<?php echo $table; ?>_price" value="" placeholder="Product Price" required>
                     </div>
                  </div>
               </div>
