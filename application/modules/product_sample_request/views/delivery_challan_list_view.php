               ...
               <div class="row">
                  ...
                  <div class="col-md-6 text-right">
                     <div class="dt-buttons">
                        ...
                        <a class="btn btn-info" href="<?php echo site_url('product_sample_request/export_delivery_challan_excel'); ?>" target="_blank">Excel</a>
                        <a class="btn btn-info" href="<?php echo site_url('product_sample_request/export_delivery_challan_pdf'); ?>" target="_blank">PDF</a>
                        <?php } ?>
                     </div>
                  </div>
               </div>
               <div class="clearfix"></div>
               <?php echo form_open('product_sample_request/get_delivery_challan_list'); ?>
                     ...
                     <table class="table color-table muted-table ">
                        <thead>
                           <tr>
                              ...
                              <th class="text-left sorting" width="8%">
                                 ...
                                 <a href="<?php echo site_url($listing_page.'client_code/ASC'); ?>">DC No</a>
                                 <?php }else{ ?>
                                 <a href="<?php echo site_url($listing_page.'client_code/DESC'); ?>">DC No</a>
                                 <?php } ?>
                              </th>
                              <th class="text-left sorting" width="8%">
                                 <?php if($this->uri->segment( 5 ) == 'DESC'){ ?>
                                 <a href="<?php echo site_url($listing_page.'delivery_challan_date/ASC'); ?>">Date</a>
                                 <?php }else{ ?>
                                 <a href="<?php echo site_url($listing_page.'delivery_challan_date/DESC'); ?>">Date</a>
                                 <?php } ?>
                              </th>
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td class="text-left">
								   <a id="<?php echo $val->delivery_challan_id; ?>" data-toggle="tooltip" class="btn" style="cursor:pointer" id="" title="Details" href="<?php echo base_url().$val->delivery_challan_file; ?>" target="_blank"><?php echo $val->delivery_challan_code; ?> <i class="fa fa-search"></i></a>
                              </td>
                              <td class="text-left"><?php echo $this->Common_model->getDateFormat($val->delivery_challan_date); ?></td>
                              <td class="text-left">
                              ...
                              <td class="text-left"><?php echo $val->despatch_mode_name; ?></td>
                              <td class="text-left"><?php echo $val->delivery_point_name; ?></td>
