                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group row">
                           ...
                           <div class="col-md-7">
                              <input type="text" name="proforma_invoice_date" class="datepicker form-control" placeholder="Date" value="<?php if(isset($proforma_invoice[0]->proforma_invoice_date)) echo $this->Common_model->getDateFormat($proforma_invoice[0]->proforma_invoice_date); ?>"> 
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
						...
						<tbody id="product_body">
							...
							?>
										<tr id="<?php echo $i; ?>">
											...
											<td align="left"><input type="text" name="tbl_purchase_order_particulars[<?php echo $i; ?>][base_price]" class="form-control text-right base_price" id="base_price_<?php echo $i; ?>" value="<?php echo $val->base_price; ?>"></td>
