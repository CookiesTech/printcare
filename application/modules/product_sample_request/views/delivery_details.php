...
<div class="form-group row">
	...
	<div class="col-md-7">
		<span id="client_name"></span>
					...
					<!--<div class="col-md-12">
						<div class="form-group row">
							<label class="control-label text-right col-md-5">Insurer</label>
							<div class="col-md-7">
								<span id="insurance_agency_name"></span>
							</div>
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group row">
							<label class="control-label text-right col-md-5">Category Name</label>
							<div class="col-md-7">
								<span id="policy_category_name"></span>
							</div>
						</div>
					</div>-->
...
<select name="ref_delivery_point_id" id="select_delivery_point" class="form-control" required>
	...
	echo $this->Common_model->getOptionList('delivery_point','delivery_point_id'); 
...
<div class="col-md-12">
	<div class="form-group row">
		...
		<div class="col-md-7">
			<input type ="text" name="dispatch_date" class="datepicker form-control" >
		</div>
	</div>
</div>
<div class="col-md-12">
	<div class="form-group row">
		...
		<div class="col-md-7">
			<input type ="text" name="delivered_date" class="datepicker form-control" >
		</div>
	</div>
</div>
<div class="col-md-12">
	<div class="form-group row">
		...
		<div class="col-md-7">
			<input type ="text" name="installation_date" class="datepicker form-control" >
		</div>
	</div>
</div>
<div class="col-md-12">
...
$('#add_sample_request_update').on('click',function(){
	...
	//alert(delivery_point_id);
	var dispatch_date = $('input[name=dispatch_date]').val();
	...
	//var settled_amount = $('input[name=settled_amount]').val();
	//var remarks_serveyor = $('textarea[name=remarks_serveyor]').val();
	//var third_party_adminstrator = $('textarea[name=third_party_adminstrator]').val();
