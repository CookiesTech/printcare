               ...
               <div class="row">
                  ...
                  <div class="col-md-6 text-right">
                     <div class="dt-buttons">
                       ...
                       <!--  <a class="btn btn-info" href="<?php echo site_url('purchase_order/export_purchase_order_excel'); ?>" target="_blank">Excel</a>
                        <a class="btn btn-info" href="<?php echo site_url('purchase_order/export_purchase_order_pdf'); ?>" target="_blank">PDF</a> -->
                        <?php } ?>
                     </div>
                  </div>
               </div>
                     ...
                     <table class="table color-table muted-table ">
                        ...
                        <tbody>
                           ...
                           <td class="text-right"><?php echo number_format($val->grand_total); ?></td>
                              ...
                              <td class="text-right" >	
                                 <?php if($stockin){ ?>
                                    <a data-toggle="tooltip" class="btn btn-info" style="cursor:pointer"  title="View Stock-In Details" href="<?php echo site_url('purchase_order/update_purchase_order_invoice/'.$val->purchase_order_id); ?>">Stock In</a>
                                 <?php }else{ ?>
                                       <?php if(!$val->mail_status){ ?>
      									<a data-toggle="tooltip" title="Send Purchase Order To Supplier" class="a-btn" href="<?php echo site_url('purchase_order/send_purchase_order/'.$val->purchase_order_id); ?>" > <i class="fa fa-envelope"></i></a>
      								 <?php } ?>	
									
                                    <a data-toggle="tooltip" class="a-btn" style="cursor:pointer"  title="Edit Purchase Order" href="<?php echo site_url('purchase_order/edit/'.$val->purchase_order_id); ?>"><i class="fa fa-pencil"></i></a>
